...
nltk.download('stopwords', download_dir='/Users/jhonsen/Documents/DS/nltk_data/')

# FUnction to print the number of cuisines
def printNum(list_cuisines, dish_type='cuisine'):
    ...
    for each in sorted(list_cuisines):
        num = df[df['title'].str.contains(each)].shape[0]
